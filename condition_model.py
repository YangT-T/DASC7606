...
class Diffuser(nn.Module):
    ...
    def _forward_diffusion(self, x_0: Tensor, t: Tensor, noise: Tensor) -> Tensor:
        ...
        # ---------- **** ---------- #
        # YOUR CODE HERE
        alphas_cumprod_t=self.alphas_cumprod.gather(-1,t).reshape(x_0.shape[0],1,1,1)
        sqrt_one_minus_alphas_cumprod_t=self.sqrt_one_minus_alphas_cumprod.gather(-1,t).reshape(x_0.shape[0],1,1,1)
